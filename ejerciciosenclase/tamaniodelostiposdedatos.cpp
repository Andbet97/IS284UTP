/*todos los tipos de datos conocidos, calcular el tama�o de todos los tipos de datos, calculr la direccion y devolver el valor de la variable*/
...
int main (void)
{
	...
	printf ("\n");
	printf ("\nENTERO (largo)");
	printf ("\nEntero b: %d \nTama�o de entero: %d\nDireccion de puntero : %p\nContenido : %d", b, sizeof(int long), b1, *b1);
	printf ("\n");
	printf ("\nENTERO (corto)");
